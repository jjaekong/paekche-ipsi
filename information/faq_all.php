		...
		<div class="container">
			<ol class="breadcrumb">
				...
				<li class="active dropdown">
					<a href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">FAQ<span class="caret"></span></a>
					...
					<div class="panel panel-default">
						...
						<div id="collapse-1" class="panel-collapse collapse in">
							<div class="panel-body">
								<i>A</i>백제예술대학교는 수시 및 정시모집에도 수능성적은 반영하지 않습니다. 
								<p class="star">반영방법은 학생부 내신 100% 또는 실기/면접고사 50% + 학생부 내신 50% 반영입니다.</p>
								<p class="star">반영과목은 2과목입니다.</p>
							</div>
						</div>
					</div>
					<div class="panel panel-default">
